    ...
    <section className="fontTartuffo relative bg-[#faf6f3] overflow-hidden py-20 px-4 md:px-92">
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-13 gap-6 items-start">
          <div
            className="col-span-13 md:col-span-9  rounded-lg shadow
          bg-[#e3f0f9]  shadow-lg flex items-center justify-between  min-h-[260px] w-full max-w-3xl"
          >
            <div className="max-w-md text-start">
              ...
              <p className="text-sm text-neutral-700 leading-snug">
                Palette de saveurs exquises pour <br /> une expérience de
                suçotage <br /> délicieusement satisfaisante et <br />{" "}
                immersive.
              </p>
            </div>
          ...
          <div className="col-span-13 md:col-span-4 bg-white rounded-lg shadow p-6 flex top-0">
           {/* Icône drapeau en haut à gauche */}
      <div className="absolute top-4 left-4 w-6 h-6">
        <img
          src="/img/french-flag-icon.png"
