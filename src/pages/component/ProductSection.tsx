...
export default function ProductSection() {
  return (
    <section className="  fontTartuffo relative bg-[#faf6f3]  py-20 px-4 md:px-92">
      {/* Background vertical lines */}
      {/* <div className="absolute inset-0 z-0 bg-lines pointer-events-none"></div> */}
      {/* section md  */}
      <div className="hidden md:block relative z-10 max-w-7xl mx-auto space-y-6">
        {/* en haut  */}
        <div className="grid grid-cols-13 gap-6">
          ...
          <div className="col-span-13 md:col-span-8 grid grid-rows-2 gap-6">
            <div
              className="rounded-xl shadow-lg overflow-hidden flex items-center justify-between bg-cover bg-no-repeat bg-left p-6 min-h-[120px]"
        ...
        <div className="grid grid-cols-13 gap-6 items-start ">
          ...
          <div className="h-full z-fullcol-span-13 md:col-span-4 bg-[#ebe0d8] rounded-lg shadow p-6 flex top-0 relative  min-h-[120px] flex-col justify-center items-center text-center w-full max-w-md">
      ...
      {/* section mobile */}
      <div className="block md:hidden relative z-10 max-w-xl mx-auto space-y-6">
        <div className="rounded-xl min-h-[120px] shadow-lg bg-card-gradient p-6 flex flex-col items-center text-center">
          <img
            src={transCote}
            alt="Élégante et sophistiquée"
        ...
        <div
          className="rounded-xl min-h-[120px] shadow-lg bg-cover bg-no-repeat bg-left p-6 min-h-[120px] text-left"
          style={{ backgroundImage: `url(${image})` }}
        >
          <div className="text-end">
            ...
            <p className="text-sm text-neutral-600 leading-snug">
              Ornements et accessoires premium <br /> pour créer une vapoteuse
              unique <br />
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-1">
          <div className="rounded-xl min-h-[120px] shadow-lg bg-white flex flex-col min-h-[280px]">
            <img
              src={frame}
              alt="Made in France"
        ...
        <div className="rounded-xl min-h-[120px] shadow-lg bg-[#e3f0f9] p-6 flex flex-col items-center text-center">
          <h3 className="text-lg font-bold text-neutral-800 mb-2 uppercase tracking-wide">
            savoureuse
          </h3>
          <p className="text-sm text-neutral-700 leading-snug mb-4">
        ...
        <div className="rounded-xl min-h-[120px] shadow-lg bg-[#ebe0d8] p-6 relative flex flex-col items-start text-start">
          <img
            src={france}
            alt="Drapeau français"
            className="absolute top-4 left-4 w-6 h-6 object-contain"
          />
          <h3 className="mt-8 text-lg font-bold text-neutral-800 mb-2 tracking-wide">
            hébergement <br /> 100% français
          </h3>
